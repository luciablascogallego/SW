<?php
//Codigo sacado de https://codeshack.io/event-calendar-php/
class Calendar {
    ...
    public function __toString() {
        ...
        $html .= $this->meses[date('m', strtotime($this->active_year . '-' . $this->active_month . '-' . $this->active_day))-1].' '. date('Y', strtotime($this->active_year . '-' . $this->active_month . '-' . $this->active_day));
        $html .= '</div>';
        $html .= '</div>';
        $html .= '<div class="days">';
