<?php
//Codigo sacado del ejemplo de full-calendar simple de la asignatura
...
switch($_SERVER['REQUEST_METHOD']) {
    ...
    case 'GET':
        try {
            ...
            if ($idEvento) {
                $result = [];
                    $result[] = Eventos_tareas::buscaPorId((int)$idEvento);
            } else {
                ...
                if ($start) {
                    ...
                    $result = Eventos_tareas::buscaEntreFechas(1, $startDateTime, $endDateTime);
                } else {
                    http_response_code(400);
